...
|Run Mobius app |<ul><li>[Standalone cluster](notes/running-mobius-app.md#standalone-cluster)</li><li>[YARN cluster](notes/running-mobius-app.md#yarn-cluster)</li></ul> |<ul><li>[Linux](notes/running-mobius-app.md#linux-instructions)</li><li>[Azure HDInsight Spark Cluster](./running-mobius-app.md#mobius-in-azure-hdinsight-spark-cluster)</li><li>[AWS EMR Spark Cluster](./running-mobius-app.md#mobius-in-amazon-web-services-emr-spark-cluster)</li> |

The current implementation of SparkCLR requires a minor customization to be applied on Apache Spark for use in Linux. To build the customized Apache Spark, follow the steps below:

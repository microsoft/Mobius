...
namespace Microsoft.Spark.CSharp.Samples
{
    class MiscSamples
    {
        ...
        internal static void PiSample()
        {
            ...
            var countComputedUsingAnotherApproach = SparkCLRSamples.SparkContext.Parallelize(values, slices).Map((x) => new PiHelper().Execute(x)).Reduce((x, y) => x + y);
        ...
        internal static int PiHelperSampleHelper()
        {

...
namespace AdapterTest
{
    ...
    public class FunctionsTest
    {
        ...
        public void TestUdfFunction()
        {
            ...
            Functions.Udf<int, int, int, int, int>((i1, i2, i3, i4) => 4).Compile().Invoke(column1, column2, column3, column4);
            ...
            Functions.Udf<int, int, int, int, int, int>((i1, i2, i3, i4, i5) => 5).Compile().Invoke(column1, column2, column3, column4, column5);
            ...
            Functions.Udf<int, int, int, int, int, int, int>((i1, i2, i3, i4, i5, i6) => 6).Compile().Invoke(column1, column2, column3, column4, column5, column6);
            ...
            Functions.Udf<int, int, int, int, int, int, int, int>((i1, i2, i3, i4, i5, i6, i7) => 7).Compile().Invoke(column1, column2, column3, column4, column5, column6, column7);
            ...
            Functions.Udf<int, int, int, int, int, int, int, int, int>((i1, i2, i3, i4, i5, i6, i7, i8) => 8).Compile().Invoke(column1, column2, column3, column4, column5, column6, column7, column8);
            ...
            Functions.Udf<int, int, int, int, int, int, int, int, int, int>((i1, i2, i3, i4, i5, i6, i7, i8, i9) => 9).Compile().Invoke(column1, column2, column3, column4, column5, column6, column7, column8, column9);
            ...
            Functions.Udf<int, int, int, int, int, int, int, int, int, int, int>((i1, i2, i3, i4, i5, i6, i7, i8, i9, i10) => 10).Compile().Invoke(column1, column2, column3, column4, column5, column6, column7, column8, column9, column10);

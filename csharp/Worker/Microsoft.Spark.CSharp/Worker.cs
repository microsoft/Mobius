...
namespace Microsoft.Spark.CSharp
{
    ...
    public class Worker
    {
        ...
        private static void ReadCommand(Stream networkStream, IFormatter formatter, out int stageId, out string deserializerMode,
        ...
        private static void ExecuteCommand(Stream networkStream, int splitIndex, DateTime bootTime,
            ...
            IFormatter formatter, Stopwatch commandProcessWatch, int stageId, int isSqlUdf)
        {
            ...
            foreach (var message in func(splitIndex, GetIterator(networkStream, deserializerMode, isSqlUdf)))
            {

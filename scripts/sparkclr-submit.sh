...
function usage() {
	...
	echo "Example 3:"
	echo "sparkclr-submit.sh [--verbose] --master spark://host:port --deploy-mode cluster [--name testapp] --exe csdriver.exe --remote-sparkclr-jar --remote-sparkclr-jar hdfs://path/to/spark-clr-1.5.2-SNAPSHOT.jar hdfs://path/to/driver.zip arg1 arg2 arg3"
}
...
export SPARKCLR_JAR=spark-clr_2.10-1.5.2-SNAPSHOT.jar

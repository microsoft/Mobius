...
if not defined SPARKCLR_JAR (set SPARKCLR_JAR=spark-clr_2.10-1.5.201-SNAPSHOT.jar)
...
:usage
	...
	@echo Example 3:
	@echo sparkclr-submit.cmd [--verbose] --master spark://host:port --deploy-mode cluster [--name testapp] --exe csdriver.exe --remote-sparkclr-jar hdfs://path/to/spark-clr_2.10-1.5.201-SNAPSHOT.jar hdfs://path/to/driver.zip arg1 arg2 arg3
